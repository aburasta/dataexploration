# Footage credits — ReelOpen (Hitler / Eva Braun remake, first 60s)

All visuals are public-domain archival sources. Voiceover is the creator's own
original audio (extracted from the uploaded video).
...
Deliberately excluded during sourcing because they carried commercial-archive
watermarks / contested status despite "PD" tags: British Pathé (Nuremberg 1936)
and Chronos Media (destroyed-Berlin color aerials).
